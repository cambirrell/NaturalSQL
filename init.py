...
names = ["Cameron", "Michael", "Katie", "Lilly", "Ryan", "Caeleb", "Simone", "Regan", "Lia", "Kathleen"]
last_names = ["Smith", "Jones", "Johnson", "Brown", "Williams", "Davis", "Miller", "Wilson", "Moore", "Taylor"]
roles = ["coach", "athlete", "official"]
states = ["CA", "TX", "FL", "NY", "PA", "IL", "OH", "GA", "NC", "MI", "WA", "UT", "AZ", "MA", "IN", "TN", "NJ", "MO", "MD", "WI"]
cities = ["Los Angeles", "Houston", "Miami", "New York", "Philadelphia", "Chicago", "Columbus", "Atlanta", "Charlotte", "Detroit", "Seattle", "Salt Lake City", "Phoenix", "Boston", "Indianapolis", "Nashville", "Newark", "St. Louis", "Baltimore", "Milwaukee"]
team_names = ["Dolphins", "Sharks", "Piranhas", "Whales", "Orcas", "Stingrays", "Seals", "Otters", "Turtles", "Tigers", "Lions", "Bears", "Wolves", "Eagles", "Falcons", "Hawks", "Cardinals", "Ravens", "Owls", "Blue Jays", "Penguins"]
...
def create_person_table():
    with engine.connect() as conn:
        ...
        for i in range(200):
            ...
            date_of_birth = datetime.date(random.randint(1970, 2005), random.randint(1, 12), random.randint(1, 28))
            active = random.choice([True, False])
            team_id = random.randint(1,21)
            insert_person = text(
                f"""
...
def create_meet_table():
    with engine.connect() as conn:
        ...
        for i in range(13):
            ...
            start_date = datetime.date(random.randint(2010, 2021), random.randint(1, 12), random.randint(1, 28))
